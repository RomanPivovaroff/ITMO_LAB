...
RUB."/>''')) #тест на возможность находить нужный блок и парсить из него стоимость
print(find_cost_BTC('''<meta name="daily_price"
content=" Цена BtC в реальном времени сегодня составляет ₽5,797,806.88
RUB."/>''')) #тест на возможность находить не только bitcoin но и btc и тест на регистрозависимость
